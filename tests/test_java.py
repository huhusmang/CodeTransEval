...
LANGUAGE = Language("tests/build/my-languages.so", "java")
...
with open("tests/file.java", "r") as file:
    code = file.read()
...
for func_node in function_nodes:
    ...
    for call_node in call_nodes:
        ...
        for child in call_node.children:
            if child.type == "identifier":
                call_node_name = get_node_text(child, code)
                break
        call_node_name_list.append(call_node_name)
